...
<ul class = "secondary_list">
      <li>Helped developed a data labeling platform with semi-auto-NER function incorporated. (accuracy around 78%) The framework is Snorkel DryBell from Standford HazyResearch Group, we also extended the frame to topic extraction task.</li>
